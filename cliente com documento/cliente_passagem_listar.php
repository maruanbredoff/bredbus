...
$query = sprintf("SELECT DISTINCT c.nome, c.documento, c.celular, p.embarque, p.desembarque, v.dataviagem, v.horaviagem, st.status, st.idstatuspass, p.idpassagem
from clientes c
...
where c.idcliente = p.idcliente and p.idcliente = $idcliente
                                            ...
                                            ?>
                                                <tr>
                                                  ...
                                                  <?php } else { ?>
                                                    ...
                                                    <td>
                                                    <a class="btn btn-danger" onclick="return confirm('Deseja cancelar essa Passagem?!')" href="#" role="button">Cancelar</a>
                                                    </td>
                                                </tr>
                                            <?php 
