...
include "../funcoes.php";
      ...
      $valortformatado = str_replace(",",".",$valort_ponto);
          ...
          $cad = mysqli_query ($con,"UPDATE passagem set embarque = '$embarque', desembarque = '$desembarque', poltrona = '$poltrona', obs = '$obs', editado_por = '$editado_por',hembarque = '$hembarque', data_edicao = '$date2' where idpassagem=$idpassagem")  or die(mysqli_error($con));
