...
<!-- FIM LAYUT ONIBUS -->
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <a href="pdf_passageiros2.php?idviagem=<?php echo $linha2['idviagem'] ?>" target="_blank" class="btn btn-info" role="button">Mapa do Onibus </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                     <label for="nome">Pesquisar:</label>
                                                        <input type="text" class="form-control" id="nome1" name="nome1" placeholder="Pesquisa por nome, celular ou rg">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" id="org" name="org" readonly>
                                                    <span class="bar"></span>
                                                </div>
                                                <div class="form-group m-b-40 col-md-3">
                                                    <label for="celular">Celular</label>
                                                    <input type="text" class="form-control" id="celular" name="celular" OnKeyPress="formatar('##-#####-####', this)" readonly>
                                                    <span class="bar"></span>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="documento">Nome mãe</label>
                                                    <input type="text" class="form-control" id="mae" name="mae" readonly>
                                                    <span class="bar"></span>
                                                </div>
                                            </div>
                                            <div class="row">
...
<script>
    var qtdpoltrona = "<?php echo $buslugares; ?>";
        const ViagemID = new URLSearchParams(window.location.search).get('idviagem');
        const totalSeats = qtdpoltrona; // Altere este valor conforme necessário

        function createSeatElement(seatNumber) {
            const td = document.createElement('td');
            td.id = `seat-${seatNumber}`;
            td.className = 'livre';
            td.textContent = seatNumber;
            return td;
        }
