...
where idviagem = $idviagem and poltrona = $poltrona
...
if($total_poltronas) { 
    ...
    $cad_passagem = mysqli_query($con,"INSERT INTO passagem (idcliente,embarque,desembarque,idagencia,obs,atendente,idviagem, poltrona, status_passagem, valor, data_cadastro, hembarque) values('$idcliente','$embarque','$desembarque','$idagencia','$obs','$atendente','$idviagem','$poltrona', '1',$valortformatado, '$date2','$hembarque')") or die(mysqli_error($con));       
...
//Insere na tabela pagamentos
    $cad_pagamento = mysqli_query($con,"INSERT INTO contas_receb_movi (idcliente,idpassagem,valor_total,desconto,qtdparcelas,data_movimento, idformapg, idsituacao) values('$idcliente','$idpassagemprox','$valortformatado','$descontoformatado','$qtdparcelas', '$date2','$idformapg','$idsituacao') ") or die(mysqli_error($con));         
}
