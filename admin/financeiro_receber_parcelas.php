...
$query = sprintf("select cr.idparcelas, crm.idmovimento, crm.idcliente,p.idpassagem, c.nome as nomecliente, p.desembarque, cr.valor, cr.valor, cr.parcela, p.embarque, cr.quem_recebeu, cr.data_pg, fp.tipo, cr.obs, cr.idsituacao, sc.situacao
