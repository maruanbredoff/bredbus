...
include_once("../config.php"); 
      ...
      $corigem = mysqli_real_escape_string($con,$_POST['corigem']);
      $cdestino = mysqli_real_escape_string($con,$_POST['cdestino']);
      ...
      $obs = mysqli_real_escape_string($con,$_POST['obs']);  
          ...
          $cad = mysqli_query ($con,"UPDATE rota set corigem = '$corigem',cdestino = '$cdestino',uforigem = '$uforigem',ufdestino = '$ufdestino',obs = '$obs' where idrota = $idrota")  or die(mysqli_error($con));
if($cad) {
include "../funcoes.php";
criaLog("Linha Editada", "Linha numero $idrota");
		...
		//header("Location: linha_cadastrar.php");
                   echo "<meta HTTP-EQUIV='refresh' CONTENT='0;URL=linha_cadastrar.php'>";  
