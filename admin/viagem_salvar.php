...
criaLog($con,"viagem cadastrada", "viagem numero $idrota"); ?>   
                    <?php
    $_SESSION['msg'] = "<div class='alert alert-success' role='alert'>Viagem Cadastrada com Sucesso<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div>";
