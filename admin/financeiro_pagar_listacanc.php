...
$query = sprintf("select distinct cpm.data_movimento, cpm.idsituacao, cpm.tipopg, cpm.valor, cpm.data_cancelamento, cpm.cancelado_por, cpm.mcancelamento, cpm.idmovipagar, sc.situacao, fp.tipo, tp.descricao 
...
where cpm.idsituacao = 3 and cpm.idcontrato = $idcontrato"); 
                ...
                <div class="row">
                    ...
                    <div class="card">
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link active" href="financeiro_pagar_listacanc.php"><i class="fa fa-trash"></i> Canceladas</a>
                                      </li>
                                    </ul>
