...
$resp_agenda = filter_input(INPUT_POST, 'resp_agenda', FILTER_SANITIZE_STRING);
...
if(!empty($title) && !empty($color) && !empty($start) && !empty($end)){
	...
	$result_events = "INSERT INTO agenda (title, color,start, end, resp_agenda, idcontrato) VALUES ('$title', '$color', '$start_sem_barra', '$end_sem_barra', '$resp_agenda', '$idcontrato')";
