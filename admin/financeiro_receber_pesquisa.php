...
where pa.status_passagem <> 4 and crm.idsituacao = 2 and EXTRACT(year FROM crm.data_movimento) = $ano and EXTRACT(month FROM crm.data_movimento) = $mes "); 
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">            
                ...
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                                <form action="financeiro_receita_pesquisa.php" class="form-horizontal" method="post">
                                    <section>
                                        <div class="row">
                                            <div class="col-md-12">
