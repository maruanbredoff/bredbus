...
$query = sprintf("select cpm.idmovireceb, cpm.data_movimento, cpm.valor, cpm.tipopg, cpm.idformapg, cpm.qtdparcelas, fp.tipo, cpm.tipopg, cpm.descricao, cpm.data_pg, sc.situacao, tp.descricao as tipo_despesa
...
if($_POST){
    ...
    //Insere na tabela pagamentos
          $cad_pagamento = mysqli_query($con,"INSERT INTO contas_priv_receb_movi (descricao,valor,idformapg,data_movimento,resp_cadastro, idsituacao, tipopg, data_pg) 
          ...
          if(mysqli_affected_rows($con) == 1){ ?>
             <div class="alert alert-success"> 
                 Cadastro Efetuado com Êxito!
                    ...
                    <?php
                   echo "<meta HTTP-EQUIV='refresh' CONTENT='2;URL=financeiro_priv_receber.php'>";    
            }
          else{ ?>
...
?>
                <div class="row">
                    ...
                    <div class="card">
                                    <ul class="nav nav-tabs">
                                      <li class="nav-item">
                                        <a class="nav-link active" href="financeiro_priv_receber.php"><i class="mdi mdi-cash-multiple"></i> Contas a Receber</a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link" href="financeiro_priv_receb_listacanc.php"><i class="fa fa-trash"></i> Canceladas</a>
                                      </li>
                                    </ul>
                    ...
                    <!-- Column -->
                                    ...
                                    <div class="table-responsive m-t-40">
                                        <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $linha['idmovireceb']?></td>
                                                    ...
                                                    <td width="166">
                                                 <a href="" class="btn btn-info btn-circle" role="button" data-toggle="modal" data-target="#editar_pagamento<?php echo $linha['idmovireceb']?>"><i class="fa fa-edit"></i></a>
                                                    <a href="" class="btn btn-danger btn-circle" role="button" data-toggle="modal" data-target="#financeiro_cancelar<?php echo $linha['idmovireceb']?>"><i class="fa fa-trash"></i></a>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="cadastrar_procedimento">Cadastrar Recebimento</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <label for="descricao">Descreva o Recebimento</label>
                ...
                $valformatado = number_format($aqui3['valor'],2, ',', '.');?>
                                <div class="modal fade bs-example-modal-lg" tabindex="-1" id="editar_pagamento<?php echo $aqui3['idmovireceb']?>" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                         ...
                         <?php  }  ?>
                                ...
                                <div class="modal fade bs-example-modal-lg" tabindex="-1" id="cadastrar_tipopg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="cadastrar_tipopg">Cadastrar Tipo PG</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="financeiro_priv_cadastrar_tipopg.php" method="post">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                    ...
                    <?php foreach($dados as $aqui2){ ?>
                                <div class="modal fade bs-example-modal" tabindex="-1" id="financeiro_cancelar<?php echo $aqui2['idmovireceb']?>" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="financeiro_priv_receb_cancelar.php" method="post">
                                                    <div class="form-group">
                                                        <label for="motivo" class="control-label">Motivo</label>
                                                        <textarea class="form-control" rows="3" id="mcancelamento" name="mcancelamento" required></textarea>
                                                        <input type="hidden" class="form-control" id="idmovireceb" name="idmovireceb" value="<?php echo $aqui2['idmovireceb'] ?>" required>
