...
if($_POST){
      ...
      $resp_cadastro = $_SESSION['UsuarioNome'];
    
    //Insere na tabela pagamentos
          $cad = mysqli_query($con,"INSERT INTO usuario(id_usuario,u_nome,usuario,senha,data_cadastro,nivel,ativo,altera_senha,resp_cadastro, idcontrato) values(NULL,'$u_nome','$usuario',SHA1('$senha'),now(),'$nivel','$ativo','$altera_senha','$resp_cadastro','$idcontrato') ") or die(mysqli_error($con)); 
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control p-0" name="nivel" id="nivel" required>
                                                          ...
                                                          <option value="2">Passagens</option>
                            ...
                            <?php foreach($dados as $aqui){ ?>
                                <div class="modal fade bs-example-modal-lg" tabindex="-1" id="editar_usuario<?php echo $aqui['id_usuario']?>" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="cadastrar_receita">Editar Usuario </h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="modal-body">
