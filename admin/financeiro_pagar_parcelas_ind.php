...
where cpm.idmovipagar = $idmovipagar"); 
                ...
                <div class="row">
                    ...
                    <div class="card">
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link" href="financeiro_pagar_parcelas.php"><i class="mdi mdi-cash-multiple"></i> Parcelas</a>
                                      </li>
                                      <li class="nav-item">
                                            ...
                                            ?>
                                                <tr>
                                                   ...
                                                   <?php if($linha['situacao']=="Pendente") {?>
                                                    <td width="50" align="center"><a class="btn btn-danger" onclick="return confirm('Deseja realmente efetuar o pagamento?')"  href="financeiro_pagar_parcelas_pg.php?idcpagar=<?php echo $linha['idcpagar'] ?>&idmovipagar=<?php echo $linha['idmovipagar']?>">Pagar</a> 
                                                    </td>
                                                    <?php } else { ?>
