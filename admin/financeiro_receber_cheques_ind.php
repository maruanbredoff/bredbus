...
$query = sprintf("select cr.idsituacao,cr.idparcelas, fr.idformapg,crm.idmovimento, crm.idcliente,t.idtratamento, c.nome as nomecliente, t.descricao, cr.valor, cr.parcela, cr.vencimento, sc.situacao, t.nometrat,cr.num_doc, cr.emitente, cr.agencia, cr.banco, cr.contadeposito, cr.depositante
...
where fr.idformapg = 4 and cr.idcliente = $idcliente and crm.idmovimento = $idmovimento
order by t.nometrat"); 
...
?>
                    ...
                    <div class="col-12">
                        <div class="card">                 
                                    <ul class="nav nav-tabs">
                                      ...
                                      <li class="nav-item">
                                        <a class="nav-link" href="financeiro_receber_cheques.php"><i class="mdi mdi-cash-multiple"></i>Cheques</a>
                                      </li>
                                    </ul>
                ...
                <div class="row">
                                 <div class="card-body wizard-content">
                                    <h4 class="card-title"><?php echo $linha['nometrat'] ?></h4>
                                        ...
                                        <table id="mytable" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td width="100" align="center">R$ <?php echo $valor_formatado?></td>
                                                    <td><?php echo $linha['num_doc']?></td>
                                                    <td><?php echo $linha['emitente']?></td>
                                                    <td><?php echo $linha['agencia']?></td>
                                                    <td><?php echo $linha['banco']?></td>
                                                    <td><?php echo $linha['contadeposito']?></td>
                                                    <td><?php echo $linha['depositante']?></td>
                                                   <?php if($linha['situacao']=="Pendente" and $linha['idformapg']!=4) {?>
                                                    <td width="50" align="center"><a class="btn btn-danger" onclick="return confirm('Deseja realmente concluir este tratamento?')"  href="cliente_financeiro_parcelas_pg.php?idparcelas=<?php echo $linha['idparcelas'] ?>&idcliente=<?php echo $linha['idcliente']?>">Pagar</a> 
                                                    </td>
                                                    <?php } else if($linha['situacao']=="Pendente" and $linha['idformapg']==4) {?>
                                                    <td width="50" align="center">
                                                    <a href="" class="btn btn-danger" role="button" data-toggle="modal" data-target="#concluir_tratamento<?php echo $linha['idparcelas']?>">Pagar</a> 
                                                    </td>
                                                    <?php } else { ?>
                                                    <td width="50" align="center"><span class="label label-success pull-center"><?php echo strtoupper($linha['situacao'])?></span></td> <?php } ?>
                                                </tr>
                                            <?php 
