...
where pa.status_passagem <> 4 and EXTRACT(year FROM crm.data_movimento) = $ano and EXTRACT(month FROM crm.data_movimento) = $mes and cr.idsituacao = 2
...
where pa.status_passagem <> 4 and cr.idsituacao = 2 and EXTRACT(year FROM cr.data_pg) = $ano and EXTRACT(month FROM cr.data_pg) = $mes"); 
