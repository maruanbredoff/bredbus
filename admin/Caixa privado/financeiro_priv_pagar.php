...
if($_POST){
    ...
    //Insere na tabela pagamentos
          $cad_pagamento = mysqli_query($con,"INSERT INTO contas_pagar_movi (descricao,valor,idformapg,data_movimento,resp_cadastro, idsituacao, tipopg, data_pg) 
          ...
          if(mysqli_affected_rows($con) == 1){ ?>
             <div class="alert alert-success"> 
                 Cadastro Efetuado com Êxito!
                    ...
                    <?php
                   echo "<meta HTTP-EQUIV='refresh' CONTENT='2;URL=financeiro_pagar.php'>";    
            }
          else{ ?>
