...
$query = sprintf("select distinct cpm.data_movimento, cp.idsituacao, cpm.tipopg, cp.valor, cpm.data_cancelamento, cpm.cancelado_por, cpm.mcancelamento, cp.idmovipagar, sc.situacao, fp.tipo, tp.descricao 
