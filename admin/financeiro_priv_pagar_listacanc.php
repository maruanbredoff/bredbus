                ...
                <div class="row">
                    ...
                    <div class="card">
                                    <ul class="nav nav-tabs">
                                      <li class="nav-item">
                                        <a class="nav-link" href="financeiro_priv_pagar.php"><i class="mdi mdi-cash-multiple"></i> Contas a Pagar</a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link active" href="financeiro_priv_pagar_listacanc.php"><i class="fa fa-trash"></i> Canceladas</a>
                                      </li>
                                    </ul>
