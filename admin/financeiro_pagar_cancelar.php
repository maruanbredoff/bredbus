...
$cad = mysqli_query($con,"update contas_pagar_movi set cancelado = 1, idsituacao = '3', data_cancelamento = '$date2', cancelado_por = '$cancelado_por', mcancelamento = '$mcancelamento' where idmovipagar=$idmovipagar") or die(mysqli_error($con));

if($cad){ 
criaLog($con, "Pagamento Cancelado", "Pagamento numero $idmovipagar"); ?>   
                    <?php
