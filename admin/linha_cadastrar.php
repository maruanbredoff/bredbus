                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="uforigem" id="estados" class="form-control" data-live-search="true" title="Selecione o Estado"></select>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                     <label for="cidade">Cidade/Origem</label>
                                                    <select name="corigem" id="cidades" class="form-control input-lg" data-live-search="true" title="Selecione a Cidade"></select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                     <label for="uforigem">Estado Destino</label>
                                                    <select name="ufdestino" id="estados2" class="form-control" data-live-search="true" title="Selecione o Estado"></select>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                     <label for="cidade">Cidade/Destino</label>
                                                    <select name="cdestino" id="cidades2" class="form-control input-lg" data-live-search="true" title="Selecione a Cidade"></select>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
