...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Jun-2024 às 23:48
...
CREATE TABLE `agencia` (
  ...
  `endereço` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `agencia` (`idagencia`, `nome`, `cep`, `endereço`, `cidade`, `estado`, `numero`, `telefone`) VALUES
(1, 'Paraiso Tur - PP', 39818000, 'rua BH', 'Padre Paraiso', 'MG', 809, 339882938),
(2, 'Paraiso Tur - ITAMB', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Paraiso Tur - Campinas', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Paraiso Tur - Betim', NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 'Renatao(PP a Lapa)', '2022-09-13 07:30:00', '2022-09-17 04:00:00', NULL, 'Gerencia', '#228B22', '', 0),
(3, 'Eva (PP A Lapa)', '2022-09-13 07:30:00', '2022-09-17 04:00:00', NULL, 'Gerencia', '#228B22', '', 0),
(4, 'Maria Ilka(AraÃ§uaÃ­ >Lapa)', '2022-09-28 08:00:00', '2022-10-01 05:00:00', NULL, 'Gerencia', '#FFD700', '', 0),
(5, 'Maria Ilka (AraÃ§uaÃ­ >Lapa)', '2022-09-28 08:00:00', '2022-10-01 05:00:00', NULL, 'Gerencia', '#228B22', '', 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `bus`
--

CREATE TABLE `bus` (
  `idbus` int(11) NOT NULL,
  `tipo` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `lugares` int(3) DEFAULT NULL,
  `placa` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
  `descricao` varchar(30) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `bus`
--

INSERT INTO `bus` (`idbus`, `tipo`, `lugares`, `placa`, `descricao`) VALUES
(1, 'Leito', 50, 'fgb3432', '50 - Lugares'),
(2, 'Leito', 46, '123456', '46 - Lugares'),
(3, 'Leito', 43, '12345678', '43 - Lugares'),
(4, 'Leito', 60, '22334455', '60 - Lugares'),
(5, 'Leito', 42, '123456', '42 - Lugares');
...
--
-- Estrutura da tabela `contas_encomendas`
--

CREATE TABLE `contas_encomendas` (
  `id` int(11) NOT NULL,
  `idencomenda` int(11) DEFAULT NULL,
  `valorpg` decimal(10,2) DEFAULT NULL,
  `formapg` varchar(11) CHARACTER SET utf8 DEFAULT NULL,
  `idsituacao` int(11) DEFAULT NULL,
  `quem_recebeu` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `datapg` datetime DEFAULT NULL,
  `obs` varchar(30) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `contas_receber` (
  ...
  `quem_recebeu` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `contas_priv_pagar` (
  `idcpagar` int(11) NOT NULL,
  `valor` decimal(10,2) NOT NULL,
  `vencimento` date DEFAULT NULL,
  `parcela` tinyint(4) NOT NULL,
...
CREATE TABLE `contas_priv_pagar_movi` (
  `idmovipagar` int(11) NOT NULL,
  `data_movimento` datetime DEFAULT NULL,
  `tipopg` int(11) DEFAULT NULL,
  `qtdparcelas` tinyint(3) NOT NULL,
...
--
CREATE TABLE `contas_priv_receb_movi` (
  `idmovireceb` int(11) NOT NULL,
  `data_movimento` datetime DEFAULT NULL,
  `tipopg` int(11) DEFAULT NULL,
  `qtdparcelas` tinyint(3) NOT NULL,
  `valor` decimal(10,2) NOT NULL,
...
--
-- Índices para tabela `contas_priv_pagar`
--
ALTER TABLE `contas_priv_pagar`
...
CREATE TABLE `motorista` (
  ...
  `nome` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `documento` varchar(16) CHARACTER SET utf8 DEFAULT NULL,
  `tel` varchar(16) CHARACTER SET utf8 DEFAULT NULL,
  `obs` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `resp_cadastro` varchar(30) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `motorista` (`idmotorista`, `nome`, `documento`, `tel`, `obs`, `resp_cadastro`) VALUES
(1, 'Teste Motorista', '077.189.396-50', '33948394839', 'teste', 'Admin');
...
CREATE TABLE `passagem` (
  ...
  `idcliente` int(11) DEFAULT NULL,
  `embarque` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `desembarque` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `idagencia` int(11) DEFAULT NULL,
  `obs` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `atendente` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `idviagem` int(11) NOT NULL,
  `poltrona` int(11) NOT NULL,
  `valor` decimal(10,2) NOT NULL,
  `status_passagem` int(11) NOT NULL,
  `cancelado_por` varchar(30) NOT NULL,
  `mcancelamento` varchar(30) NOT NULL,
  `data_cancelamento` datetime DEFAULT NULL,
  `data_cadastro` datetime DEFAULT NULL,
  `editado_por` varchar(20) NOT NULL,
  `data_edicao` datetime DEFAULT NULL,
  `hembarque` time DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `poltronas` (`idpoltrona`, `numero`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
--
-- Estrutura da tabela `poltronas42`
--

CREATE TABLE `poltronas42` (
  `idpoltrona` int(11) NOT NULL,
  `numero` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `poltronas42`
--

INSERT INTO `poltronas42` (`idpoltrona`, `numero`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
--
-- Estrutura da tabela `poltronas43`
--

CREATE TABLE `poltronas43` (
  `idpoltrona` int(11) NOT NULL,
  `numero` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `poltronas43`
--

INSERT INTO `poltronas43` (`idpoltrona`, `numero`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
--
-- Estrutura da tabela `poltronas46`
--

CREATE TABLE `poltronas46` (
  `idpoltrona` int(11) NOT NULL,
  `numero` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `poltronas46`
--

INSERT INTO `poltronas46` (`idpoltrona`, `numero`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
--
-- Estrutura da tabela `poltronas60`
--

CREATE TABLE `poltronas60` (
  `idpoltrona` int(11) NOT NULL,
  `numero` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `poltronas60`
--

INSERT INTO `poltronas60` (`idpoltrona`, `numero`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
--
-- Estrutura da tabela `poltronas_ocupadas`
--

CREATE TABLE `poltronas_ocupadas` (
  `id` int(11) NOT NULL,
  `id_poltrona` int(11) DEFAULT NULL,
  `idpassagem` int(11) DEFAULT NULL,
  `idviagem` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `rota` (
  ...
  `corigem` varchar(40) CHARACTER SET utf8 DEFAULT NULL,
  `cdestino` varchar(40) CHARACTER SET utf8 DEFAULT NULL,
  `obs` varchar(30) CHARACTER SET utf8 NOT NULL,
  `resp_cadastro` varchar(30) CHARACTER SET utf8 NOT NULL,
  `uforigem` varchar(3) CHARACTER SET utf8 NOT NULL,
  `ufdestino` varchar(3) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `rota` (`idrota`, `corigem`, `cdestino`, `obs`, `resp_cadastro`, `uforigem`, `ufdestino`) VALUES
(6, 'Padre Paraiso', 'Belo Horizonte', '', 'funcionario', 'MG', 'MG'),
(9, 'Belo Horizonte', 'Padre Paraiso', '', 'funcionario', 'MG', 'MG'),
(10, 'Padre Paraiso', 'Extrema', '', 'luciana', 'MG', 'MG'),
(11, 'Padre Paraiso', 'Campinas', '', 'Elaine', 'MG', 'SP'),
(13, 'Campinas-SP', 'Padre Paraiso', '', 'Gerencia', 'SP', 'MG'),
(21, 'Padre Paraiso-MAL', 'Nova Serrana', '', 'Gerencia', 'MG', 'MG'),
(22, 'Nova Serrana', 'PP-Malacacheta', '', 'Gerencia', 'MG', 'MG');
...
(2, 'Veículo', NULL, ''),
(3, 'Geral', NULL, ''),
(4, 'Luz', '2023-08-10 00:00:00', 'Admin'),
(5, 'Sistema', '2023-08-10 00:00:00', 'Admin');
...
CREATE TABLE `usuario` (
  ...
  `altera_senha` varchar(3) NOT NULL,
...
(1, 'Admin', '976B05F793FF426E5FC3AEE138954BBEF2984D8A', 10, 'admin', 1, '2018-11-18', 'Administrador', '0', 5, ''),
(10, 'Gerencia', '0bfddce6e0f24ce1e3f84411fc5785b2cb7a77e5', 10, 'gerencia', 1, '2022-07-31', 'Administrador', 'Nao', 0, '');
...
CREATE TABLE `viagem` (
  `idviagem` int(11) NOT NULL,
  `obs` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `motorista1` varchar(30) CHARACTER SET utf8 NOT NULL,
  `motorista2` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `idrota` int(11) NOT NULL,
  `dataviagem` date NOT NULL,
  `horaviagem` time NOT NULL,
  `idbus` int(11) NOT NULL,
  `atendente` varchar(30) NOT NULL,
  `editado_por` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


--
-- Estrutura da tabela `viagem_encomenda`
--

CREATE TABLE `viagem_encomenda` (
  `idencomenda` int(11) NOT NULL,
  `idviagem` int(11) DEFAULT NULL,
  `etiqueta` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
  `descricao` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `remetente` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `destinatario` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `localhorigem` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `localdestino` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `telremetente` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `teldestinatario` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `valor` decimal(10,2) DEFAULT NULL,
  `idsituacao` int(11) DEFAULT NULL,
  `obs` varchar(30) DEFAULT NULL,
  `docremetente` varchar(20) NOT NULL,
  `docdestinatario` varchar(20) NOT NULL,
  `atendente` varchar(30) NOT NULL,
  `cancelado_por` varchar(30) NOT NULL,
  `mcancelamento` varchar(30) NOT NULL,
...
--
-- Estrutura da tabela `viagem_motorista`
--
...
--
-- Índices para tabela `contas_encomendas`
--
ALTER TABLE `contas_encomendas`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `passagem`
  ...
  ADD KEY `fk_agencia` (`idagencia`),
  ADD KEY `fk_viagem` (`idviagem`);

--
-- Índices para tabela `poltronas`
--
ALTER TABLE `poltronas`
  ADD PRIMARY KEY (`idpoltrona`);

--
-- Índices para tabela `poltronas42`
--
ALTER TABLE `poltronas42`
  ADD PRIMARY KEY (`idpoltrona`);

--
-- Índices para tabela `poltronas43`
--
ALTER TABLE `poltronas43`
  ADD PRIMARY KEY (`idpoltrona`);

--
-- Índices para tabela `poltronas46`
--
ALTER TABLE `poltronas46`
  ADD PRIMARY KEY (`idpoltrona`);

--
-- Índices para tabela `poltronas60`
--
ALTER TABLE `poltronas60`
  ADD PRIMARY KEY (`idpoltrona`);

--
-- Índices para tabela `poltronas_ocupadas`
--
ALTER TABLE `poltronas_ocupadas`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices para tabela `viagem_encomenda`
--
ALTER TABLE `viagem_encomenda`
  ADD PRIMARY KEY (`idencomenda`);

--
-- Índices para tabela `viagem_motorista`
--
ALTER TABLE `viagem_motorista`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `contas_encomendas`
--
ALTER TABLE `contas_encomendas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `contas_pagar`
  MODIFY `idcpagar` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `contas_pagar_movi`
--
ALTER TABLE `contas_pagar_movi`
  MODIFY `idmovipagar` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `contas_priv_pagar`
--
ALTER TABLE `contas_priv_pagar`
  MODIFY `idcpagar` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `contas_priv_pagar_movi`
--
ALTER TABLE `contas_priv_pagar_movi`
  MODIFY `idmovipagar` int(11) NOT NULL PRIMARY key AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `contas_priv_receb_movi`
--
ALTER TABLE `contas_priv_receb_movi`
  MODIFY `idmovireceb` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `contas_receber`
--
ALTER TABLE `contas_receber`
  MODIFY `idparcelas` smallint(6) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `formapg`
  MODIFY `idformapg` int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `poltronas`
  MODIFY `idpoltrona` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `poltronas60`
--
ALTER TABLE `poltronas60`
  MODIFY `idpoltrona` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `poltronas_ocupadas`
--
ALTER TABLE `poltronas_ocupadas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `situacao_caixa`
  MODIFY `idsituacao` tinyint(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tipopg`
--
ALTER TABLE `tipopg`
  MODIFY `idtipopg` tinyint(5) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `viagem_encomenda`
--
ALTER TABLE `viagem_encomenda`
  MODIFY `idencomenda` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `viagem_motorista`
--
ALTER TABLE `viagem_motorista`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `contas_pagar`
  ADD CONSTRAINT `fk_movipagar_id` FOREIGN KEY (`idmovipagar`) REFERENCES `contas_pagar_movi` (`idmovipagar`) ON DELETE CASCADE;
...
--
ALTER TABLE `passagem`
  ADD CONSTRAINT `fk_agencia` FOREIGN KEY (`idagencia`) REFERENCES `agencia` (`idagencia`),
  ADD CONSTRAINT `fk_cliente` FOREIGN KEY (`idcliente`) REFERENCES `clientes` (`idcliente`),
  ADD CONSTRAINT `fk_viagem` FOREIGN KEY (`idviagem`) REFERENCES `viagem` (`idviagem`);
