                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="cadastrar_linha">Cadastrar Linha/Rota</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="uforigem" id="estado" class="form-control">
                                                        <option value="">Selecione um Estado</option>
                                                        <?php 
                                                        $q = mysqli_query($con,"SELECT *
                                                        FROM estados where id = 11") or die(mysqli_error());    
                                                        if(mysqli_num_rows($q)){ 
                                                        //faz o loop para preencher o campo criado com os valores retornados na consulta 
                                                        while($line = mysqli_fetch_array($q)) 
                                                        { 
                                                        echo "<option value='".$line['id']."'>".$line['uf']."</option>";
                                                        } 
                                                        }
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <select name="corigem" id="cidade" class="form-control input-lg" data-live-search="true" title="Selecione a Cidade">>
                                                        <?php 
                                                        $q = mysqli_query($con,"SELECT *
                                                        FROM cidades where estado = 11") or die(mysqli_error());    
                                                        if(mysqli_num_rows($q)){ 
                                                        //faz o loop para preencher o campo criado com os valores retornados na consulta 
                                                        while($line = mysqli_fetch_array($q)) 
                                                        { 
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                     <label for="uforigem">Estado Destino</label>
                                                    <select name="ufdestino" id="estado2" class="form-control">
                                                        <option value="">Selecione um Estado</option>
                                                        <?php 
                                                        $q = mysqli_query($con,"SELECT *
                                                        FROM estados where id = 11") or die(mysqli_error());    
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <select name="cdestino" id="cidade2" class="form-control input-lg" data-live-search="true" title="Selecione a Cidade">
                                                        <?php 
                                                        $q = mysqli_query($con,"SELECT *
                                                        FROM cidades where estado = 11") or die(mysqli_error());    
                                                        if(mysqli_num_rows($q)){ 
